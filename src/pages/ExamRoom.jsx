        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div className="flex-1 overflow-y-auto hide-scrollbar bg-slate-50/50 dark:bg-gray-900/20">
            ...
            <div className="p-4 md:p-8 flex flex-col items-center">
              {/* Progress (Mini) */}
              <div className="mb-8 w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto flex items-center gap-4">
              ...
              {/* Question Card */}
              <div className={`w-full max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto card p-5 md:p-8 space-y-5 md:space-y-6 shadow-xl transition-colors ${isDark ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100 shadow-slate-200/50'}`}>
